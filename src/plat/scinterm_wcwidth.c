 ...
 * @brief Unicode character width implementation for Scinterm NotCurses
 *
 * Based on Markus Kuhn's wcwidth implementation and Unicode standard tables.
 * Returns 0 for combining/control characters, 2 for East Asian Wide/Fullwidth,
...
/* Structure to represent a range of Unicode codepoints */
struct interval {
    uint32_t first;
    uint32_t last;
};

/* Table of combining (zero-width) characters.
 * Generated from Unicode 15.0 data. */
...
/* Table of East Asian Wide and Fullwidth characters.
 * Generated from Unicode 15.0 data. */
static const struct interval wide[] = {
    ...
    { 0x18D00, 0x18D7F },
    { 0x1AFF0, 0x1AFFF }, /* Katakana Phonetic Extensions */
    ...
    { 0x1FAE0, 0x1FAE8 },
    { 0x1FAF0, 0x1FAF8 },
    { 0x20000, 0x2A6DF }, /* CJK Unified Ideographs Extension B-G */
    { 0x2A700, 0x2B73F },
    { 0x2B740, 0x2B81F },
    { 0x2B820, 0x2CEAF },
    { 0x2CEB0, 0x2EBEF },
...
int scinterm_wcswidth_utf8(const char *str, int len) {
    ...
    while (i < len || (len < 0 && str[i])) {
        ...
        if (w < 0) w = 0;  /* treat control chars as 0 width for string width */
        total += w;
        i += bytes;
    }
